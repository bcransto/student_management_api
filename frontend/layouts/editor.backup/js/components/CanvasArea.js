        ...
        layout.tables.map((table) =>
          React.createElement(
            ...
            React.createElement(
              ...
              {
                className:
                  "absolute text-white text-2xl font-bold pointer-events-none",
                style: {
                  top: "50%",
                  left: "50%",
              ...
              table.seats.map((seat) =>
                React.createElement(
                  "div",
                  {
                    ...
                    className: `absolute w-6 h-6 rounded-md flex items-center justify-center text-xs font-bold pointer-events-none transition-colors ${
                      seat.is_accessible
                    ...
                    style: {
                      left: `calc(${seat.relative_x * 100}% - 12px)`, // Center the 24px square
                      top: `calc(${seat.relative_y * 100}% - 12px)`, // Center the 24px square
                    },
