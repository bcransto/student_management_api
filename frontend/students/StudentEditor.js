...
const StudentEditor = ({ studentId, navigateTo, apiModule }) => {
  ...
  const deleteConfirmDialog = showDeleteConfirm ? React.createElement(
    'div',
  ...
  return React.createElement(
    ...
    // Error display
    errors.fetch && React.createElement(
      'div',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          errors.student_id && React.createElement(
            'span',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            errors.first_name && React.createElement(
              'span',
              { className: 'error-message' },
              errors.first_name
            )
          ...
          React.createElement(
            ...
            errors.last_name && React.createElement(
              'span',
              { className: 'error-message' },
              errors.last_name
            )
        ...
        // Error messages
        errors.save && React.createElement(
          'div',
          { className: 'alert alert-danger' },
          errors.save
        ),
      ...
      React.createElement(
        ...
        enrolledClasses.length > 0 ? React.createElement(
          'div',
          ...
          enrolledClasses.map((roster) =>
            React.createElement(
              ...
              React.createElement(
                ...
                roster.class_assigned_details?.grade_level && React.createElement(
                  'span',
              ...
              React.createElement(
                ...
                roster.class_assigned_details?.teacher_name && React.createElement(
                  'span',
                  null,
                  'Teacher: ',
